...
openai.api_base = "https://api.bltcy.cn"
...
def final_judgement(tweet, favor_response, against_response, target):
    judgement = get_completion(
        f"Determine whether the sentence is in favor of or against {target}, or is irrelevant to {target}.\n \
